...
<head>
	...
	<style type="text/css">
		...
		function lastPages()
		{
			location.href = "/ezen/goods/search/${keyword}/${lvl}/${code}/${pageInfo.pages}";
		}

		function firstPages()
		{
			location.href = "/ezen/goods/search/${keyword}/${lvl}/${code}/1";
		}
		...
		function nextPages()
		{
			...
			{
				$('#nbtn').disabled = "disabled";
			}
			location.href = "/ezen/goods/search/${keyword}/${lvl}/${code}/${pageInfo.nextPage}";
		}
		...
		function previousPages()
		{
			...
			location.href = "/ezen/goods/search/${keyword}/${lvl}/${code}/${pageInfo.prePage}";
		}
		</script>
	...
	<div id="hearder">
	 	header
			...
			<div id="icon">
				...
				[<a href="javascript:goMemerInfo(${uid});">마이페이지</a>]
	 	...
	 	<div id="main">
			...
			<div id="p">
				<button type="button" onclick="javascript:firstPages();"> << </button>
				<button id="pbtn" type="button" onclick="javascript:previousPages();"> < </button>
				<c:forEach var="page" items="${pageInfo.navigatepageNums}" >
					<c:choose>
						...
						<c:otherwise>
							<a href="/ezen/goods/search/${keyword}/${lvl}/${code}/${page}">${page}</a>	
						</c:otherwise>
					</c:choose>
				</c:forEach>
				<button id="nbtn" type="button" onclick="javascript:nextPages();"> > </button>	
				<button type="button" onclick="javascript:lastPages();"> >> </button>	
			</div>
